...
#    inserimento in xloader ma rallenta molto l'harvesting ->
#    os.popen('/usr/lib/ckan/default/bin/ckan -c /etc/ckan/default/ckan.ini xloader submit '+str(pkg.get('id'))).read()
